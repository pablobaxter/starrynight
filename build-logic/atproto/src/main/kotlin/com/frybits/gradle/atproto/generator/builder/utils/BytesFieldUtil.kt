...
internal fun FunSpec.Builder.handleParam(name: String, lexiconType: BytesField, isRequired: Boolean, isNullable: Boolean) {
...
internal fun TypeSpec.Builder.handleProperty(name: String, lexiconType: BytesField, isNullable: Boolean) {
    val typeName = ByteArray::class.asTypeName().copy(nullable = isNullable)
    val property = PropertySpec.builder(name, typeName)
        .initializer(name)
        .addAnnotation(
            AnnotationSpec.builder(Serializable::class)
                .addMember("%T::class", TypeNames.BytesSerializer)
                .build()
        )
