...
internal fun FunSpec.Builder.handleParam(name: String, lexiconType: UnionField, isRequired: Boolean, isNullable: Boolean, context: LexiconContext) {
    val typeName = ClassName(context.authority, "${context.name}Union").copy(nullable = isNullable)
...
internal fun TypeSpec.Builder.handleProperty(name: String, lexiconType: UnionField, isNullable: Boolean, context: LexiconContext) {
    val typeName = ClassName(context.authority, "${context.name}Union").copy(nullable = isNullable)
