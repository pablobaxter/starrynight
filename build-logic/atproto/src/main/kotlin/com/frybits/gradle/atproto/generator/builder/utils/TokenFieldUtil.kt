...
internal fun FunSpec.Builder.handleParam(name: String, lexiconType: TokenField, isRequired: Boolean, isNullable: Boolean) {
    val typeName = String::class.asTypeName().copy(nullable = isNullable)
...
internal fun TypeSpec.Builder.handleProperty(name: String, lexiconType: TokenField, isNullable: Boolean) {
    val typeName = String::class.asTypeName().copy(nullable = isNullable)
