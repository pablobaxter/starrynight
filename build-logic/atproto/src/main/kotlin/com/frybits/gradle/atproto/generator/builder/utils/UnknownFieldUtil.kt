...
internal fun FunSpec.Builder.handleParam(name: String, lexiconType: UnknownField, isRequired: Boolean, isNullable: Boolean) {
...
internal fun TypeSpec.Builder.handleProperty(name: String, lexiconType: UnknownField, isNullable: Boolean) {
    val typeName = JsonObject::class.asTypeName().copy(nullable = isNullable)
