...
internal fun FunSpec.Builder.handleParam(name: String, lexiconType: CidLinkField, isRequired: Boolean, isNullable: Boolean) {
...
internal fun TypeSpec.Builder.handleProperty(name: String, lexiconType: CidLinkField, isNullable: Boolean) {
    val typeName = URI::class.asTypeName().copy(nullable = isNullable)
