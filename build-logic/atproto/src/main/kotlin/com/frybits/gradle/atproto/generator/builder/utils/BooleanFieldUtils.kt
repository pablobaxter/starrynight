...
internal fun TypeSpec.Builder.handleConst(name: String, lexiconType: BooleanField) {
...
internal fun FunSpec.Builder.handleParam(name: String, lexiconType: BooleanField, isRequired: Boolean, isNullable: Boolean) {
...
internal fun TypeSpec.Builder.handleProperty(name: String, lexiconType: BooleanField, isNullable: Boolean) {
    val typeName = Boolean::class.asTypeName().copy(nullable = isNullable)
